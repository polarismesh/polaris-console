...
export async function describeServiceCircuitBreaker(
  params: DescribeServiceCircuitBreakerParams
) {
...
export async function createServiceCircuitBreaker(
  params: CreateCircuitBreakerParams[]
) {
...
export async function createServiceCircuitBreakerVersion(
  params: CreateCircuitBreakerVersionParams[]
) {
  const res = await apiRequest<any>({
...
export async function modifyServiceCircuitBreaker(
  params: ModifyCircuitBreakerParams[]
) {
...
export async function releaseServiceCircuitBreaker(
  params: ReleaseServiceCircuitBreakerParams[]
) {
  const res = await apiRequest<any>({
